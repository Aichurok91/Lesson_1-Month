...
# python_file = open('test.py', 'w')
# python_file.write("print('Hello workd')")
# python_file.close()
...
#     new.write("New file not close")
#     new.write("Привет GEEKS!")

# with open('new.txt', 'r', encoding = 'utf-8') as read_file:
#    print(read_file.read())
